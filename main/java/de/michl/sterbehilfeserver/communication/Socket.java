 ...
 * vorgenommen werden.
 * Ob die Verbindungsanforderung erfolgreich war, kann durch den RŸckgabewert
...
public class Socket {
    ...
    /**
     * Konstruktor
     * Erzeugt einen neuen Socket mit dem angegebenen Socket.
...
//  --- Implementierung Leseoperationen ------------------------------
     ...
     * ('\n' linefeed) abgeschlossen sein muss. Der zurŸckgegebene
     * String enthŠlt die Zeile ohne Zeilenendezeichen.
     * Die Methode blockiert, bis Eingabe-Daten verfŸgbar sind.
